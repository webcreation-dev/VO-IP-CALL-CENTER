...
INSERT INTO ps_endpoints (id, tenant_id, transport, aors, auth, context, disallow, allow, direct_media) 
VALUES ('101', 1, 'transport-udp', '101', '101', 'client-a-context', 'all', 'ulaw,alaw,g722', 'no');
...
INSERT INTO ps_endpoints (id, tenant_id, transport, aors, auth, context, disallow, allow, direct_media) 
VALUES ('102', 1, 'transport-udp', '102', '102', 'client-a-context', 'all', 'ulaw,alaw,g722', 'no');
...
INSERT INTO ps_endpoints (id, tenant_id, transport, aors, auth, context, disallow, allow, direct_media) 
VALUES ('201', 2, 'transport-udp', '201', '201', 'client-b-context', 'all', 'ulaw,alaw,g722', 'no');
...
INSERT INTO ps_endpoints (id, tenant_id, transport, aors, auth, context, disallow, allow, direct_media) 
VALUES ('202', 2, 'transport-udp', '202', '202', 'client-b-context', 'all', 'ulaw,alaw,g722', 'no');
